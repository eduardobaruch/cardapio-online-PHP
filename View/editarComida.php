                ...
                <div class="container card bg-light mt-1">
                    <div class="input-group mt-2 mb-3">
                        <div class="input-group">
                            <button class="btn btn-outline-secondary" type="button" data-toggle="" aria-haspopup="true">Comida</button>

                        </div>

                    </div>
                    <form method="POST" action="../Controller/itemController.php">
                        <div class="form-group"><label for="usrname">Nome da Comida:</label><input class="form-control" value="<?php echo $_GET['nome'] ?>" type="text" id="nome" name="nome"></div>
                        <div class="form-group"><label for="email">Descrição da Comida:</label><input class="form-control" value="<?php echo $_GET['descricao'] ?>" type="text" id="descricao" name="descricao" /></div>
                        <div class="input-group">
