                ...
                <div class="container card bg-light mt-1">
                    <div class="input-group mt-2 mb-3">
                        <div class="input-group">
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true">Bebida</button>
                    ...
                    <form method="POST" action="../Controller/itemController.php">
                        <div class="form-group"><label for="usrname">Nome da Bebida:</label><input class="form-control" type="text" id="nome" name="nome" /></div>
                        <div class="form-group"><label for="email">Fornecedor da Bebida:</label><input class="form-control" type="text" id="fornecedor" name="fornecedor" /></div>
                        <div class="input-group">
                            <label for="preco">Preço R$</span>
                                <input type="number" value="0.00" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="c2" name="preco" />
                        </div>
                        <input type="hidden" name="acao" value="cadastrarBebida" id="acao">
                        <div class="container">
